...
public class SearchNameAdapter extends BaseAdapter implements SectionIndexer {
    /** inflater  */
     ...
     */
    public SearchNameAdapter(Context context, ArrayList<WordNameAdapterItem> wordList){
